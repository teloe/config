...
" Base Colors
" ------------------------------------------------
hi Boolean           guifg=#c1D951      guibg=#323232      gui=NONE
...
hi Constant          guifg=#999999      guibg=NONE         gui=NONE
...
hi EndOfBuffer       guifg=#9933cc      guibg=NONE         gui=NONE
hi Error             guifg=#AB2217      guibg=NONE         gui=NONE
hi ErrorMsg          guifg=#AB2217      guibg=NONE         gui=NONE
...
hi Number            guifg=#C1D951      guibg=NONE         gui=NONE
hi Operator          guifg=#A46321      guibg=NONE         gui=NONE
" hi PreProc           guifg=#75759f      guibg=NONE         gui=NONE
hi PreProc           guifg=#C1D951      guibg=NONE         gui=NONE
...
hi StatusLine        guifg=#dddddd      guibg=#33383a      gui=NONE
