...
hi Delimiter      guifg=#ffffff ctermfg=252 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Keyword        guifg=#ffffff ctermfg=252 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
hi MatchParen     guifg=#d0d0d0 ctermfg=252 guibg=#1100AA ctermbg=20 gui=NONE cterm=NONE
...
hi Statement      guifg=#f5f5f5 ctermfg=251 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
" hi Statement      guifg=#949494 ctermfg=246 guibg=NONE ctermbg=NONE gui=Bold cterm=Bold
...
hi Type           guifg=#eeeeee ctermfg=255 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Visual         guifg=NONE ctermfg=NONE guibg=#2f3e52 ctermbg=60 gui=NONE cterm=NONE
hi WarningMsg     guifg=#8787af ctermfg=103 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LineNr         guifg=#6c6c6c ctermfg=242 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CursorLineNr   guifg=#3a3a3a ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Pmenu          guifg=#b2b2b2 ctermfg=249 guibg=#22252c ctermbg=234 gui=NONE cterm=NONE
hi PmenuSel       guifg=#ffffff ctermfg=238 guibg=#2f3e52 ctermbg=66 gui=NONE cterm=NONE
hi PmenuSbar      guifg=#1c1c1c ctermfg=NONE guibg=#22252c ctermbg=234 gui=NONE cterm=NONE
